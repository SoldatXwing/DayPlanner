...
namespace DayPlanner.Abstractions.Services
{
    public interface IAppointmentsService
    {
        ...
        Task DeleteUsersAppointment(string appointmentId);
    ...
    public class AppointmentsService : IAppointmentsService
    {
        ...
        public async Task<Appointment> CreateAppointment(AppointmentRequest request) => request is null ? throw new ArgumentNullException(nameof(request), "Appointment cant be null.") : await _appointmentStore.CreateAppointment(request);
        public async Task DeleteUsersAppointment(string appointmentId)
        {
            if (string.IsNullOrEmpty(appointmentId))
                throw new ArgumentNullException(nameof(appointmentId), "Appointment Id cant be null or empty.");
            await _appointmentStore.DeleteAppointment(appointmentId);
        }
